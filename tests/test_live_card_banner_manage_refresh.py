...
class LiveCardBannerManageRefreshTests(unittest.TestCase):
    def test_back_to_live_card_reloads_library_favorites(self):
    ...
    def test_live_card_uses_most_recent_four_banner_favorites(self):
