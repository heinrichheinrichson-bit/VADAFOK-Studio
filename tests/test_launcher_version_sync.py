...
class LauncherVersionSyncTests(unittest.TestCase):
    def test_application_version_has_four_numeric_parts(self) -> None:
    ...
    def test_launcher_metadata_uses_central_version(self) -> None:
