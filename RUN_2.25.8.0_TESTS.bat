...
echo ============================================================
echo VADAFOK Studio 2.25.8.0 - Refresh Pattern Analyzer
echo ============================================================
echo.
...
echo.
echo [2/3] Gezielte Pattern-Analyzer-Tests...
%PYTHON_CMD% -m unittest tests.test_template_refresh_pattern_analyzer
if errorlevel 1 goto :failed
