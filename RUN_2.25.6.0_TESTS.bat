...
echo ============================================================
echo VADAFOK Studio 2.25.6.0 - Refresh Chain Analyzer
echo ============================================================
echo.
...
echo.
echo [2/3] Gezielte Chain-Analyzer-Tests...
%PYTHON_CMD% -m unittest tests.test_template_refresh_chain_analyzer
if errorlevel 1 goto :failed
